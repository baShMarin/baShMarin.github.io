...
`Enigma` es una máquina virtual Windows Server 2012 intencionadamente vulnerable. Se trata de una máquina preconfigurada para la reproducción de técnicas manuales de explotación para entornos windows.
